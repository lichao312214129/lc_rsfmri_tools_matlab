function [ANCOVA_F, ANCOVA_P] = My_gretna_ANCOVA(DependentFiles, Covariates)
...
[b_OLS_metric, t_OLS_metric, ANCOVA_F, r_OLS_metric] = My_gretna_GroupAnalysis(DependentMatrix, Regressors, Contrast, 'F');
