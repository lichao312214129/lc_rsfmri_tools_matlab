function varargout = MVPA_Classification_GUI(varargin)
% MVPA_CLASSIFICATION_GUI MATLAB code for MVPA_Classification_GUI.fig
%      MVPA_CLASSIFICATION_GUI, by itself, creates a new MVPA_CLASSIFICATION_GUI or raises the existing
%      singleton*.
%
%      H = MVPA_CLASSIFICATION_GUI returns the handle to a new MVPA_CLASSIFICATION_GUI or the handle to
%      the existing singleton*.
%
%      MVPA_CLASSIFICATION_GUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MVPA_CLASSIFICATION_GUI.M with the given input arguments.
%
%      MVPA_CLASSIFICATION_GUI('Property','Value',...) creates a new MVPA_CLASSIFICATION_GUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before MVPA_Classification_GUI_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to MVPA_Classification_GUI_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help MVPA_Classification_GUI

% Last Modified by GUIDE v2.5 02-Nov-2017 10:15:46

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @MVPA_Classification_GUI_OpeningFcn, ...
    'gui_OutputFcn',  @MVPA_Classification_GUI_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before MVPA_Classification_GUI is made visible.
function MVPA_Classification_GUI_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to MVPA_Classification_GUI (see VARARGIN)

% Choose default command line output for MVPA_Classification_GUI
handles.opt={...
    'num_fold','10';....
...
% UIWAIT makes MVPA_Classification_GUI wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = MVPA_Classification_GUI_OutputFcn(hObject, eventdata, handles)
...
OPT.permutation=0;
%% run
[best_AUC, best_Accuracy,best_Sensitivity,best_Specificity] =...
