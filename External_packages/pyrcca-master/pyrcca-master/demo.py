# -*- coding: utf-8 -*-
"""
Created on Fri Oct 18 21:30:22 2019
...
train1 = data1[:np.int(nSamples/2),:]
train2 = data2[:np.int(nSamples/2)]
test1 = data1[np.int(nSamples/2):]
test2 = data2[np.int(nSamples/2):]
