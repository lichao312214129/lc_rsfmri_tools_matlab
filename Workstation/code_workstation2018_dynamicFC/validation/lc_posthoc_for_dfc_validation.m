function  lc_posthoc_for_dfc_validation()
...
if nargin < 1
    ...
    load ('D:\WorkStation_2018\WorkStation_dynamicFC_V3\Data\results\results_dfc\V1\results_of_individual\results_ancova_posthocttest_validataion_addSES\dfc_STATS_results_fdr.mat');
    mask = triu(H,1) == 1;
