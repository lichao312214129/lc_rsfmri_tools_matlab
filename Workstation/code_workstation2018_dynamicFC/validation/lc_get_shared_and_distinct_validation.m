function [shared_1and2and3,shared_1and2,shared_1and3,shared_2and3,...
          distinct_1,distinct_2,distinct_3]=lc_get_shared_and_distinct_validataion(h_mat,t_mat)
...
if nargin<1
    % input
    posthoc_szvshc = 'D:\WorkStation_2018\WorkStation_dynamicFC_V3\Data\results\results_dfc\V1\results_of_individual\results_ancova_posthocttest_validataion_addSES\dfc_posthoc_szvshc_results_fdr';
    posthoc_mddvshc = 'D:\WorkStation_2018\WorkStation_dynamicFC_V3\Data\results\results_dfc\V1\results_of_individual\results_ancova_posthocttest_validataion_addSES\dfc_posthoc_mddvshc_results_fdr';
    posthoc_bdvshc = 'D:\WorkStation_2018\WorkStation_dynamicFC_V3\Data\results\results_dfc\V1\results_of_individual\results_ancova_posthocttest_validataion_addSES\dfc_posthoc_bdvshc_results_fdr';
    ...
    if_save=1;
    save_path='D:\WorkStation_2018\WorkStation_dynamicFC_V3\Data\results\results_dfc\V1\results_of_individual\results_ancova_posthocttest_validataion_addSES';
end
