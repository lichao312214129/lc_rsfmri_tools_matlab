...
% 
% EXAMPLE:
  % lc_posthoc_for_fc('-dd', 'D:\WorkStation_2018\WorkStation_dynamicFC_V3\Data\results\windowlength20__silhoutte_and_davies-bouldin\daviesbouldin\individual_state3', ...
  % '-dmf', 'D:\WorkStation_2018\WorkStation_dynamicFC_V3\Data\ID_Scale_Headmotion\covariates_737.xlsx', ...
  % '-hma', 'D:\WorkStation_2018\WorkStation_dynamicFC_V3\Data\results\windowlength20__silhoutte_and_davies-bouldin\daviesbouldin\state3_addmedication_ANCOVA_FDR_Corrected_0.05_2020628204713.mat',...
  % '-cid', 1, '-cgl', 2,...
  % '-od', 'D:\WorkStation_2018\WorkStation_dynamicFC_V3\Data\results\windowlength20__silhoutte_and_davies-bouldin\daviesbouldin', ...
  % '-on', 'state3_addmedication');
% 
...
for i = 1:(n_groups*(n_groups-1)/2)
    ...
    if is_save
        ...
        save (fullfile(output_directory,[output_name, '_', savename{i}, '_',correction_method, num2str(correction_threshold), '_', timenow, '.mat']),'test_info','Tvalues','Pvalues_posthoc','H_posthoc', 'cohen_d_posthoc');
        disp('saved results');
    end
end
fprintf('--------------------------All Done!--------------------------\n');
