...
% input£º
%   ZFC_*£ºROI wise FC matrix, size=N*N,where N is number of ROI.
%   ID_Mask£ºif only perform analyses on a sub-group ROI, then giving the mask to filter ROI; default is 'ALL'.
% output£º
