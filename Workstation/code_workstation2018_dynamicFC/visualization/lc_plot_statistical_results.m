...
saveas(gcf,fullfile(results_root, 'group_mean_and_Fvalues_20TR.pdf'))
...
saveas(gcf,fullfile(results_root,'posthoc_patientsVScontrols_and_shared_dysconnectivity_20TR.pdf'))
...
saveas(gcf,fullfile(results_root,'unique_dysconnectivity_20TR.pdf'))
...
saveas(gcf,fullfile(results_root,'posthoc_patientsVSpatients_20TR.pdf'))


%% TODO: Plot effect size 