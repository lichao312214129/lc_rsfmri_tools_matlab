...
#    sel = BarPlotForFC(x_location=loc, savename=r'D:\WorkStation_2018\Workstation_dynamic_FC_V2\Figure\Supp\Bar\bar_intranetwork_s2.tiff')
#    prepdata_intra = sel.prepdata(data_intra)
#    plt.figure(figsize=(5,4))
#    sel._plot(prepdata_intra)
    ...
    prepdata_inter=sel.prepdata(data_inter)
    plt.figure(figsize=(5,4))
    sel._plot(prepdata_inter)
