...
figure
[index1,re_net_index1,re_net1] = lc_netplot(Fvalues,0,mask_path,'all',0,1, net_index_path);
colormap(jet)
% caxis([0 10]);
...
% print(gcf,'-dtiff', '-r1200','D:\WorkStation_2018\WorkStation_dynamicFC_V3\Data\results_cluster\figure\Fvalues.tif')
