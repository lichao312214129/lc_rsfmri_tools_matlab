function [zDynamicFC,zStaticFC]=lc_dfc(time_series, window_step, window_length, window_type, window_alpha)
%  Used to calculate  roi-wise dynamic fc using sliding-window method for on subject
% input:
...
if strcmp(window_type, 'Gaussian')
	windowvector = icatb_compute_sliding_window(window_length, window_alpha, window_length);
else
