classdef circularGraph_v0 < handle
    ...
    methods
        function this = circularGraph_v0(adjacencyMatrix,varargin)
            % Constructor
            p = inputParser;
            ...
            this.ShowButton = uicontrol(...
                ...
                'Position',[0 40 80 40],...
                'String','Show All',...
                'Callback',@circularGraph_v0.showNodes,...
                'UserData',this);
            ...
            this.HideButton = uicontrol(...
                ...
                'Position',[0 0 80 40],...
                'String','Hide All',...
                'Callback',@circularGraph_v0.hideNodes,...
                'UserData',this);
            
            fig = gcf;
            set(fig,...
                'UserData',this,...
                'CloseRequestFcn',@circularGraph_v0.CloseRequestFcn);
