classdef circularGraph_v1 < handle
    ...
    methods
        function this = circularGraph_v1(adjacencyMatrix,varargin)
            % Constructor
            p = inputParser;
            ...
            this.ShowButton = uicontrol(...
                ...
                'Position',[0 40 80 40],...
                'String','Show All',...
                'Callback',@circularGraph_v1.showNodes,...
                'UserData',this);
            ...
            this.HideButton = uicontrol(...
                ...
                'Position',[0 0 80 40],...
                'String','Hide All',...
                'Callback',@circularGraph_v1.hideNodes,...
                'UserData',this);
            
            fig = gcf;
            set(fig,...
                'UserData',this,...
                'CloseRequestFcn',@circularGraph_v1.CloseRequestFcn);
