...
node_name_path = 'F:\Àè³¬\Workstation_dynamic_fc\Data\Network_and_plot_para\17network_label.xlsx';
which_group = 1;
if_save_subfigure = 0;
save_name = '';
...
% state 1
axes(ha(1)); 
net_path='F:\Àè³¬\Workstation_dynamic_fc\Data\Dynamic\state1\tvalue_posthoc_fdr.mat';
mask_path='F:\Àè³¬\Workstation_dynamic_fc\Data\Dynamic\state1\result1\shared_1and2_fdr.mat';
...
axes(ha(2)); 
net_path='F:\Àè³¬\Workstation_dynamic_fc\Data\Dynamic\state1\tvalue_posthoc_fdr.mat';
mask_path='F:\Àè³¬\Workstation_dynamic_fc\Data\Dynamic\state1\shared_1and2_fdr.mat';
