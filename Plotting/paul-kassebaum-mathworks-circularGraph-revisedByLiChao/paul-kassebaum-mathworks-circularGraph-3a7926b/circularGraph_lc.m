classdef circularGraph_lc < handle
    ...
    methods
        function this = circularGraph_lc(adjacencyMatrix,varargin)
            % Constructor
            p = inputParser;
            ...
            this.ShowButton = uicontrol(...
                ...
                'Position',[0 40 80 40],...
                'String','Show All',...
                'Callback',@circularGraph_lc.showNodes,...
                'UserData',this);
            ...
            this.HideButton = uicontrol(...
                ...
                'Position',[0 0 80 40],...
                'String','Hide All',...
                'Callback',@circularGraph_lc.hideNodes,...
                'UserData',this);
            
            fig = gcf;
            set(fig,...
                'UserData',this,...
                'CloseRequestFcn',@circularGraph_lc.CloseRequestFcn);
