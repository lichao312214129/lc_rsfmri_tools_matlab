function varargout = lc_fmriToolbox1(varargin)
% 此代码用来对影像数据标准化
% LC_FMRITOOLBOX1 MATLAB code for lc_fmriToolbox1.fig
%      LC_FMRITOOLBOX1, by itself, creates a new LC_FMRITOOLBOX1 or raises the existing
%      singleton*.
%
%      H = LC_FMRITOOLBOX1 returns the handle to a new LC_FMRITOOLBOX1 or the handle to
%      the existing singleton*.
%
%      LC_FMRITOOLBOX1('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in LC_FMRITOOLBOX1.M with the given input arguments.
%
%      LC_FMRITOOLBOX1('Property','Value',...) creates a new LC_FMRITOOLBOX1 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before lc_fmriToolbox1_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to lc_fmriToolbox1_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help lc_fmriToolbox1

% Last Modified by GUIDE v2.5 26-Oct-2019 23:02:17

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @lc_fmriToolbox1_OpeningFcn, ...
    'gui_OutputFcn',  @lc_fmriToolbox1_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before lc_fmriToolbox1 is made visible.
function lc_fmriToolbox1_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to lc_fmriToolbox1 (see VARARGIN)
handles.img_path=pwd;
handles.img_path_name={};
handles.mask_data=[];
handles.howStand='Zstandard';
handles.save_folder=pwd;
% Choose default command line output for lc_fmriToolbox1
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes lc_fmriToolbox1 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = lc_fmriToolbox1_OutputFcn(hObject, eventdata, handles)
